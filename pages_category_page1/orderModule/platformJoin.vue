...
<template>
	<view>
		<view class="content">
			<view class="afterSale-select-box mt20">
				<view class="item item-start">
					<view class="l">问题描述</view>
				</view>
		    <textarea class="text-area" placeholder="填写相关问题" placeholder-style="color:#bbb;" bindinput="proofRemarkInput"></textarea>
			</view>
			...
			<view class="afterSale-select-box mt20">
				...
				<view class="upload-img-box">
					<view class="upload-img-item-box">
						<image src="../../static/images/afterSaleClose.png" class="afterSale-close-img" bindtap="imageItemDel" ></image>
					</view>
					<view class="single" v-if="returnImgsList< 3">
						<view class="single-kuang" bindtap="uploadImg">
							<text class="jiahao">+</text>
							<text class="upload-word">上传凭证</text>
						</view>
						<view class="single-num">(0/3)</view>
					</view>
				</view>
			</view>
		</view>
		...
		<view class="order-confirm-box">
			<text class="btn" bindtap="subimtTap">提交</text>
		</view>
	</view>
</template>
