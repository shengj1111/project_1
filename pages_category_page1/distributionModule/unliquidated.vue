	...
	<view>
		<view class="unliquidated-topBackImg flex-items flex-column">
			<view class="totalAward-content flex-column font-color-FFF">
				<view class="flex-row-plus flex-items  mar-top-60">
					<label>未结算奖励(元）</label>
					<label class="fs60">{{ZSalesOrderData.total}}</label>
				</view>
				<view class="flex-row-plus flex-sp-between fs24 mar-top-30">
					<view class="flex-row-plus flex-items">
						<label class="">直接奖励(元）</label>
						<label>{{ZSalesOrderData.directPrice}}</label>
					</view>
					<view class="lineright">|</view>
					<view class="flex-row-plus flex-items">
						<label class="">间接奖励(元）</label>
...
<style lang="scss">
	...
	.unliquidated-topBackImg {
		width: 100%;
		height: 230upx;
		// background: url(../../static/images/unliquidatedTopBackImg.png) no-repeat;
